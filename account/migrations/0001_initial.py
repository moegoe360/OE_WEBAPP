    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Required. 150 characters or fewer. Letters, digits and @/./+/-/_ only.', error_messages={'unique': 'A user with that username already exists.'}, unique=True, validators=[account.validator.UnicodeUsernameValidator], max_length=150, verbose_name='username')),
                ('email', models.EmailField(unique=True, null=True, max_length=254, blank=True, verbose_name='email address')),
