"""
Django settings for OE_Platform project.
...
SECRET_KEY = '!xh_f^z$vlrj_7rj3h&v%$5ny!1gj$8q$heq=%ymcg1pf2di94'
...
WSGI_APPLICATION = 'OE_Platform.wsgi.application'
